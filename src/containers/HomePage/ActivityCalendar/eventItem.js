...
const EventItem = (props) => {
    ...
    const isSelected = (selectEventCnt.selectedEvent && selectEventCnt.selectedEvent.id === event.id)

    const eventClasses = [classes.eventsli, isSelected ? classes.active:null].join(' ');
