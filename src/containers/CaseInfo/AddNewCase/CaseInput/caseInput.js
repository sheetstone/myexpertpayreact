    ...
    if (isChild){
      return (
        <Form.Group controlId={objkey} className={isTail?classes.indentTail:classes.indent}>
          ...
          <button onClick={addChild} className={classes.addBtn} title="Add child" type="button"></button>
          <button onClick={removeChild} className={classes.removeBtn} title="Delete" type="button"></button>
