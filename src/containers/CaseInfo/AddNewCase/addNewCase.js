...
const AddNewCase = props => {
  ...
  const caseNumber = formCreator('caseNumber', register, formState, initalState, errors);
  const ncpName = formCreator('ncpName', register, formState, initalState, errors);
  const initalChildrenList = formCreator('childName', register, formState, initalState, errors)
